...
export class buyerController {
    ...
    async getSeller(req: AuthenticatedUserRequest, res: Response, next: NextFunction) {
        try {
    ...
    async getProductsBySellerId(req: AuthenticatedUserRequest, res: Response, next: NextFunction) {
        try {
    ...
    async createOrder(req: AuthenticatedUserRequest, res: Response, next: NextFunction) {
        try {
